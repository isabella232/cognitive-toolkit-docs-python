...
> If you are coming from another deep learning toolkit you can start with an [overview for advanced users](https://github.com/Microsoft/CNTK/blob/release/2.5.1/Tutorials/CNTK_200_GuidedTour.ipynb).
...
[Tutorials/NumpyInterop/FeedForwardNet.py](https://github.com/Microsoft/CNTK/blob/release/2.5.1/Tutorials/NumpyInterop/FeedForwardNet.py)).
